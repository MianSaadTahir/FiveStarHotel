    ...
    public partial class SignUp : Form
    {
        ...
        private void SignUpBtn_Click(object sender, EventArgs e)
        {
               ...
               && StudentDb.IsDuplicateStudent(username.Text, ConnectionString))
            {
                ...
                Dwellers dweller  = new Student(username.Text,password.Text, int.Parse(age.Text),Cnic.Text,role.Text.ToLower(),gender.Text.ToLower());
                ...
                int Id = DwellerDB.GetDwellerId(dweller.GetName(), ConnectionString);
